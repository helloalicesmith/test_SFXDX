...
const characters = createSlice({
  ...
  reducers: {
    ...
    fetchCharactersSuccess: (state: CharactersState, action: PayloadAction<Array<CharactersType>>): void => {
    ...
    setSearchValue: (state: CharactersState, action: PayloadAction<string>): void => {
      state.searchValue = action.payload
    },

    fetchCharacterDetails: (state: CharactersState, _action: PayloadAction<string>): void => {
      state.characterDetails = null
      state.isDetailsLoading = true
    },
    fetchCharacterDetailsSuccess: (state: CharactersState, action: PayloadAction<CharacterDetailsType>): void => {
